...
function upload(response, exec, postData, spawn) {
  ...
  response.write("<br>");
  response.write("You're Clone_url is : " +
    querystring.parse(postData).Clone_url);
  response.write("<br>");
...
function template_001(response) {
  console.log("Request handler 'template_001' was called.");
  fs.readFile("/michael/nodejs-centos/websample/img/template_001.png", "binary", function (error, file) {
    if (error) {
      response.writeHead(500, { "Content-Type": "text/plain" });
      response.write(error + "\n");
      response.end();
...
exports.show = show;
exports.logo = logo;
exports.template_001 = template_001;
exports.web_upload = web_upload;
